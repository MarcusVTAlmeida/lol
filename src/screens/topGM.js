...
function HeaderT({ setCurrentTab }) {
  return (
    <View style={styles.padding}>
	  ...
	  <Text style={{color:'white', fontSize:16, borderWidth: 2}}>GRANDMASTER</Text>
...
export default class topGM extends React.Component {
	constructor(props){
		super(props);
		this.state ={
			jogadores:[],
  ...
  static navigationOptions = {
    headerTitle: 'Os melhores do grão mestre',
    };
	toggleOpen = () => {
  ...
  _handlePress(){   
	fetch("https://br1.api.riotgames.com/lol/league/v4/grandmasterleagues/by-queue/RANKED_FLEX_SR?api_key=RGAPI-4d66b037-2cd4-4de8-8486-2fcdfcbf0be0")
...
_handlePress2(){
	fetch("https://br1.api.riotgames.com/lol/league/v4/grandmasterleagues/by-queue/RANKED_SOLO_5x5?api_key=RGAPI-4d66b037-2cd4-4de8-8486-2fcdfcbf0be0")
    .then(response => response.json())
    .then((responseJson)=> {
      this.setState({
