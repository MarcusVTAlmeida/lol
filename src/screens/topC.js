...
function HeaderT({ setCurrentTab }) {
  return (
    <View style={styles.padding}>
	  ...
	  <Text style={{color:'white', fontSize:16, borderWidth: 2}}>CHALLENGER</Text>
...
export default class topC extends React.Component {
	constructor(props){
		super(props);
		this.state ={
			jogadores:[],
  ...
  static navigationOptions = {
    headerTitle: 'Os melhores do desafiante',
    };
	toggleOpen = () => {
  ...
  _handlePress(){   
	fetch("https://br1.api.riotgames.com/lol/league/v4/challengerleagues/by-queue/RANKED_FLEX_SR?api_key=RGAPI-4d66b037-2cd4-4de8-8486-2fcdfcbf0be0")
